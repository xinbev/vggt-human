...
SMPL_CKPT="${SMPL_CKPT:-${REPO_ROOT}/outputs/train/smpl_translation_ray_refine_full_from0121/stage2_transl_heads_ray_refiner/checkpoint_latest.pt}"
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/eval/smpl_translation_ray_refine_full_from0121/manual_final_translation}"
...
echo "========== Eval SMPL Translation Ray Refine =========="
...
echo "========== Eval finished =========="
echo "Metrics: ${OUTPUT_DIR}/smpl_translation_metrics.json"
