...
# Per-person diagnostics for known bad-frame inspection after the validated
# camera-ray translation repair. This reports base-vs-GT and HSI-vs-GT SMPL
# errors per frame/person so we can tell whether the remaining failure is
# already present in the repaired base SMPL translation.
...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/eval/hsi_bad_frame_after_translation_ray_refine}"
...
echo "========== HSI bad-frame per-person diagnostics =========="
...
echo "========== HSI bad-frame per-person diagnostics finished =========="
