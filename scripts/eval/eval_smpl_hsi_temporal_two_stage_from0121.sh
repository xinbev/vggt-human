...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/eval/hsi_temporal_two_stage_from0121}"
...
echo "========== SMPL HSI temporal two-stage metrics =========="
...
echo "========== SMPL HSI temporal two-stage metrics finished =========="
