...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/eval/hsi_clip_affine_relaxed_contact}"
...
echo "========== SMPL HSI clip-affine relaxed-contact temporal metrics =========="
...
echo "========== SMPL HSI clip-affine relaxed-contact temporal metrics finished =========="
