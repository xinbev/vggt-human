...
# Check SMPL DAB joint-refine results with bbox metrics and joint visualizations.
...
TRAIN_CONFIG="${REPO_ROOT}/configs/train_smpl_dab_joint_refine.yaml"
...
SMPL_CKPT="${REPO_ROOT}/outputs/train/smpl_dab_joint_refine_20q/checkpoint_latest.pt"

EVAL_CLEAN_DIR="${REPO_ROOT}/outputs/eval/smpl_dab_joint_refine_20q_gt_prior"
EVAL_NOISY_DIR="${REPO_ROOT}/outputs/eval/smpl_dab_joint_refine_20q_noisy_prior_c005_s010"
VIS_CLEAN_DIR="${REPO_ROOT}/outputs/vis/smpl_dab_joint_refine_20q_gt_prior"
VIS_NOISY_DIR="${REPO_ROOT}/outputs/vis/smpl_dab_joint_refine_20q_noisy_prior_c005_s010"
...
[[ -f "${SMPL_CKPT}" ]] || { echo "[ERROR] Missing SMPL joint-refine checkpoint: ${SMPL_CKPT}" >&2; exit 1; }
...
echo "========== SMPL DAB Joint-Refine Check =========="
...
echo "========== Visualization: clean/noisy projected SMPL joints =========="
...
echo "========== SMPL DAB Joint-Refine check finished =========="
