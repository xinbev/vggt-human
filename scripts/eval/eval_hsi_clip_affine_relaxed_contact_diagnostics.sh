...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/eval/hsi_clip_affine_relaxed_contact_diagnostics}"
...
echo "========== HSI clip-affine relaxed-contact diagnostics =========="
...
echo "========== HSI clip-affine relaxed-contact diagnostics finished =========="
