...
SMPL_CKPT="${SMPL_CKPT:-${REPO_ROOT}/outputs/train/smpl_hsi_temporal_from0121/checkpoint_latest.pt}"
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/eval/hsi_temporal_from0121}"
...
echo "========== SMPL HSI temporal metrics =========="
...
echo "========== SMPL HSI temporal metrics finished =========="
