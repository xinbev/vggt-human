...
HUMAN_MASK_DEPTH_MARGIN_M="${HUMAN_MASK_DEPTH_MARGIN_M:-0.45}"
...
echo "Human mask  : SMPL hull + ${HUMAN_MASK_DILATION_PX}px dilation + ${HUMAN_MASK_DEPTH_MARGIN_M}m depth margin"
...
ARGS=(
  ...
  --human-mask-depth-margin-m "${HUMAN_MASK_DEPTH_MARGIN_M}"
