...
SMPL_CKPT="${SMPL_CKPT:-${REPO_ROOT}/outputs/train/smpl_hsi_graft_probe_guarded_from0121/checkpoint_latest.pt}"
IMAGE_PATH="${IMAGE_PATH:-${BEDLAM_ROOT}/Training/20221013_3_250_batch01hand_orbit_bigOffice_seq_000000/rgb/seq_000000_0000.png}"
VIS_OUTPUT_DIR="${VIS_OUTPUT_DIR:-${REPO_ROOT}/outputs/vis/smpl_hsi_graft_probe_guarded_gt_prior_aligned}"
DIAG_VIS_OUTPUT_DIR="${DIAG_VIS_OUTPUT_DIR:-${REPO_ROOT}/outputs/vis/hsi_graft_probe_guarded_depth_smpl_diagnostics}"
DIAG_EVAL_OUTPUT_DIR="${DIAG_EVAL_OUTPUT_DIR:-${REPO_ROOT}/outputs/eval/hsi_graft_probe_guarded_depth_smpl_diagnostics}"
...
echo "========== SMPL HSI GRAFT-probe guarded visualization =========="
...
echo "========== GRAFT-probe guarded visualization finished =========="
