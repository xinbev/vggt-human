...
# Clip/GIF visualization for the two-stage scene-affine + temporal-momentum model.
...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/vis/hsi_scene_then_temporal_momentum_clip}"
...
echo "========== SMPL HSI scene-then-temporal-momentum GIF =========="
