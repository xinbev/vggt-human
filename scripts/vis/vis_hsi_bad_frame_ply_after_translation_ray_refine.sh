...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/vis/hsi_bad_frame_after_translation_ray_refine_ply}"
...
PLY_FRAME_STEMS="${PLY_FRAME_STEMS:-seq_000000_0100}"
...
echo "========== HSI known bad-frame PLY export =========="
...
echo "========== HSI known bad-frame PLY export finished =========="
