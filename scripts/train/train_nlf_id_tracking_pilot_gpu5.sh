...
OUTPUT_DIR="${REPO_ROOT}/outputs/train/nlf_id_tracking_pilot_gpu5"
...
python -u scripts/train/train_smpl.py \
  ...
  --device cuda \
  --override "experiment.name=nlf_id_tracking_pilot_gpu5" \
...
echo "========== NLF ID tracking pilot finished =========="
