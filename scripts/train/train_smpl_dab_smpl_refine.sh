...
TRAIN_CONFIG="${REPO_ROOT}/configs/train_smpl_dab_smpl_refine.yaml"
...
OUTPUT_DIR="${REPO_ROOT}/outputs/train/smpl_dab_smpl_refine_20q"
...
echo "========== SMPL DAB SMPL Refinement Stage =========="
...
echo "========== SMPL DAB SMPL Refinement finished =========="
