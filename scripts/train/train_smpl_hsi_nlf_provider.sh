...
echo "SMPL scale T : weight=${HSI_SMPL_SCALE_TEACHER_WEIGHT}, source=${HSI_SMPL_SCALE_TEACHER_SOURCE}, window=${HSI_SMPL_SCALE_TEACHER_WINDOW}, vis_tol=${HSI_SMPL_SCALE_TEACHER_VIS_TOL_M}"
