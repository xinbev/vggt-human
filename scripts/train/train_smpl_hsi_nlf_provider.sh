...
HSI_TRANSL_CLEAN_IDENTITY_WEIGHT="${HSI_TRANSL_CLEAN_IDENTITY_WEIGHT:-0.0}"
HSI_TRANSL_NOISE_GATE_WEIGHT="${HSI_TRANSL_NOISE_GATE_WEIGHT:-0.0}"
HSI_TRANSL_GATE_FULL_OPEN_M="${HSI_TRANSL_GATE_FULL_OPEN_M:-0.10}"
...
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES_VALUE}" python scripts/train/train_smpl.py \
  ...
  --override "loss.hsi_transl_clean_identity_weight=${HSI_TRANSL_CLEAN_IDENTITY_WEIGHT}" \
  --override "loss.hsi_transl_noise_gate_weight=${HSI_TRANSL_NOISE_GATE_WEIGHT}" \
  --override "loss.hsi_transl_gate_full_open_m=${HSI_TRANSL_GATE_FULL_OPEN_M}" \
