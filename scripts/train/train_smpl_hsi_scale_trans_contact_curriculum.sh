...
STAGE2A_RESUME_REQUIRED_PREFIXES="${STAGE2A_RESUME_REQUIRED_PREFIXES:-hsi_refinement_head.}"
...
if contains_stage 2A; then
  ...
  (
    ...
    export RESUME_REQUIRED_PREFIXES="${STAGE2A_RESUME_REQUIRED_PREFIXES}" FROZEN_HASH_PREFIXES=hsi_refinement_head.
