...
TRAIN_CONFIG="${REPO_ROOT}/configs/train_smpl_gt_box_prior.yaml"
...
OUTPUT_DIR="${REPO_ROOT}/outputs/train/smpl_gt_box_prior_20q"
...
echo "========== SMPL GT Box Prior Query Stage =========="
...
echo "========== SMPL GT Box Prior Query finished =========="
