...
def build_model(config: dict[str, Any]) -> VGGTOmega:
    ...
    return VGGTOmega(
        ...
        hsi_grounding_hard_gate_train=bool(model_cfg.get("hsi_grounding_hard_gate_train", False)),
        hsi_grounding_hard_gate_eval=bool(model_cfg.get("hsi_grounding_hard_gate_eval", True)),
        hsi_grounding_initial_gate_probability=float(
            model_cfg.get("hsi_grounding_initial_gate_probability", 0.5)
        ),
...
def compact_loss_name(key: str) -> str:
    mapping = {
        ...
        "metric_hsi_grounding_severe_float_recall": "groundFloatRecall",
        "metric_hsi_grounding_clean_false_apply_rate": "groundCleanFAR",
        "metric_hsi_grounding_negative_false_apply_rate": "groundNegFAR",
        "metric_hsi_grounding_positive_gate_mean": "groundPosProb",
        "metric_hsi_grounding_negative_gate_mean": "groundNegProb",
        "metric_hsi_grounding_severe_base_p95_m": "groundSevBaseP95",
        "metric_hsi_grounding_severe_candidate_p95_m": "groundSevCandP95",
        "metric_hsi_grounding_severe_refined_p95_m": "groundSevRefP95",
        "metric_hsi_grounding_severe_improvement_rate": "groundSevImprove",
        "metric_hsi_grounding_severe_selection": "groundSevSelect",
