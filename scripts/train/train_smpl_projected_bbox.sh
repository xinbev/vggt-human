...
TRAIN_CONFIG="${REPO_ROOT}/configs/train_smpl_projected_bbox.yaml"
...
RESUME_CKPT="${REPO_ROOT}/outputs/train/smpl_hungarian_20q/checkpoint_latest.pt"
OUTPUT_DIR="${REPO_ROOT}/outputs/train/smpl_projected_bbox_20q"
...
echo "========== SMPL Projected BBox Stage 2 =========="
...
echo "========== SMPL Projected BBox finished =========="
