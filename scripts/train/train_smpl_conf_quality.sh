...
TRAIN_CONFIG="${REPO_ROOT}/configs/train_smpl_conf_quality.yaml"
...
OUTPUT_DIR="${REPO_ROOT}/outputs/train/smpl_conf_quality_20q"
...
echo "========== SMPL Confidence Quality Stage =========="
...
echo "========== SMPL Confidence Quality finished =========="
