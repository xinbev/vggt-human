...
CONFIG="${CONFIG:-${REPO_ROOT}/configs/overfit_smpl_temporal_stabilizer_v2.yaml}"
...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/debug/smpl_temporal_stabilizer_v2_translation_e0}"
...
echo "========== V2 E0: fixed translation stabilizer overfit =========="
echo "Output: ${OUTPUT_DIR}"
echo "Steps : ${STEPS}; this must pass before full training."

python scripts/train/overfit_smpl_temporal_stabilizer_v2.py \
  --config "${CONFIG}" \
