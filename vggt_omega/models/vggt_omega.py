...
class VGGTOmega(nn.Module):
    ...
    def __init__(
        ...
        hsi_align_gate_application_mode: str = "sigmoid_v1",
        hsi_align_gate_deadzone: float = 0.50,
        ...
        hsi_v4_ray_parameterization: str = "residual_gain",
        hsi_v4_max_ray_gain: float = 4.0,
        ...
        hsi_grounding_exclusion_vertices: int = 0,
        hsi_grounding_support_window: int = 31,
        hsi_grounding_support_min_points: int = 32,
        ...
        hsi_grounding_clearance_deadzone_m: float = 0.025,
        hsi_grounding_max_root_delta_m: float = 0.12,
        hsi_grounding_gate_threshold: float = 0.5,
        hsi_grounding_hard_gate_train: bool = False,
        hsi_grounding_hard_gate_eval: bool = True,
        hsi_grounding_initial_gate_probability: float = 0.5,
        ...
        self.hsi_refinement_head = (
            HSIRefinementHead(
                ...
                transl_delta_mode=hsi_transl_delta_mode,
                use_affine_depth_for_transl=hsi_use_affine_depth_for_transl,
                affine_depth_detach=hsi_affine_depth_detach,
        ...
        self.hsi_human_scene_align_head = (
            HSIHumanSceneAlignHead(
                ...
                gate_application_mode=hsi_align_gate_application_mode,
                gate_deadzone=hsi_align_gate_deadzone,
        ...
        self.hsi_translation_refine_v4_head = (
            HSITranslationRefineV4Head(
                ...
                ray_parameterization=hsi_v4_ray_parameterization,
                max_ray_gain=hsi_v4_max_ray_gain,
        ...
        self.hsi_grounding_head = (
            HSIGroundingHead(
                ...
                clearance_deadzone_m=hsi_grounding_clearance_deadzone_m,
                max_root_delta_m=hsi_grounding_max_root_delta_m,
                gate_threshold=hsi_grounding_gate_threshold,
                hard_gate_train=hsi_grounding_hard_gate_train,
                hard_gate_eval=hsi_grounding_hard_gate_eval,
                initial_gate_probability=hsi_grounding_initial_gate_probability,
